...
type checkpointOracle struct {
	config   *goethereum.CheckpointOracleConfig
	contract *checkpointoracle.CheckpointOracle

	running  int32                                     // Flag whether the contract backend is set or not
	getLocal func(uint64) goethereum.TrustedCheckpoint // Function used to retrieve local checkpoint
}

// newCheckpointOracle returns a checkpoint registrar handler.
func newCheckpointOracle(config *goethereum.CheckpointOracleConfig, getLocal func(uint64) goethereum.TrustedCheckpoint) *checkpointOracle {
	if config == nil {
...
func (reg *checkpointOracle) stableCheckpoint() (*goethereum.TrustedCheckpoint, uint64) {
