...
var (
	...
	ClassicChainConfig = &coregeth.CoreGethChainConfig{
		...
		TrustedCheckpoint: &ctypes.TrustedCheckpoint{
			SectionIndex: 589,
			SectionHead:  common.HexToHash("0x3e1a6ba15ac95eb7581aace5ca4ff22c84774d9d02463ba067458bdfb7f9d430"), // hash
			CHTRoot:      common.HexToHash("0xeee20c45a8e7e729d75b59790de6ce71fce3cd9509a0f05f2675fce0231ba8dd"), // stateRoot

			// BloomRoot is unnecessary and tough to derive (without les client or server).
			// It is not used in header or block validation by the downloader or handlers.
