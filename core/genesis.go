...
func GenesisToBlock(g *Genesis, db ethdb.Database) *types.Block {
	if db == nil {
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc:      decodePrealloc(params.MainnetAllocData),
	}
}
...
func DefaultTestnetGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc:      decodePrealloc(params.TestnetAllocData),
	}
}
...
func DefaultRinkebyGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc:      decodePrealloc(params.RinkebyAllocData),
	}
}
...
func DefaultGoerliGenesisBlock() *Genesis {
	return &Genesis{
		...
		GasLimit:   10485760,
		Difficulty: big.NewInt(1),
		Alloc:      decodePrealloc(params.GoerliAllocData),
	}
}
