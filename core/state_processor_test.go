...
func TestStateProcessorErrors(t *testing.T) {
	...
	{ // Tests against a 'recent' chain definition
		...
		for i, tt := range []struct {
			...
			{ // ErrNonceTooLow
				txs: []*types.Transaction{
					makeTx(0, common.Address{}, big.NewInt(0), vars.TxGas, big.NewInt(875000000), nil),
					makeTx(0, common.Address{}, big.NewInt(0), vars.TxGas, big.NewInt(875000000), nil),
				},
			...
			{ // ErrNonceTooHigh
				txs: []*types.Transaction{
					makeTx(100, common.Address{}, big.NewInt(0), vars.TxGas, big.NewInt(875000000), nil),
				},
			...
			{ // ErrInsufficientFundsForTransfer
				txs: []*types.Transaction{
					makeTx(0, common.Address{}, big.NewInt(1000000000000000000), vars.TxGas, big.NewInt(875000000), nil),
				},
			...
			{ // ErrInsufficientFunds
				txs: []*types.Transaction{
					makeTx(0, common.Address{}, big.NewInt(0), vars.TxGas, big.NewInt(900000000000000000), nil),
				},
			...
			{ // ErrIntrinsicGas
				txs: []*types.Transaction{
					makeTx(0, common.Address{}, big.NewInt(0), vars.TxGas-1000, big.NewInt(875000000), nil),
				},
