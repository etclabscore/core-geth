...
type NodeInfo struct {
	...
	CHT        paramtypes.TrustedCheckpoint `json:"cht"`        // Trused CHT checkpoint for fast catchup
}
...
func (c *lesCommons) latestLocalCheckpoint() paramtypes.TrustedCheckpoint {
...
func (c *lesCommons) localCheckpoint(index uint64) paramtypes.TrustedCheckpoint {
