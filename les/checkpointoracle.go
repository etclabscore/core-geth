...
type checkpointOracle struct {
	config   *paramtypes.CheckpointOracleConfig
	contract *checkpointoracle.CheckpointOracle

	running  int32                                     // Flag whether the contract backend is set or not
	getLocal func(uint64) paramtypes.TrustedCheckpoint // Function used to retrieve local checkpoint
}

// newCheckpointOracle returns a checkpoint registrar handler.
func newCheckpointOracle(config *paramtypes.CheckpointOracleConfig, getLocal func(uint64) paramtypes.TrustedCheckpoint) *checkpointOracle {
	if config == nil {
...
func (reg *checkpointOracle) stableCheckpoint() (*paramtypes.TrustedCheckpoint, uint64) {
